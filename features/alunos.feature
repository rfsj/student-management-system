Feature: Aceitacao do CRUD de alunos
  ...
  Scenario: Create de aluno com sucesso
    ...
    When eu crio um aluno com nome "Ana" e email "ana@escola.com"
  ...
  Scenario: List de alunos com sucesso
    Given o ambiente de alunos esta limpo
    And existe um aluno com nome "Bruno" e email "bruno@escola.com"
  ...
  Scenario: Update de aluno com sucesso
    Given o ambiente de alunos esta limpo
    And existe um aluno com nome "Carla" e email "carla@escola.com"
  ...
  Scenario: Delete de aluno com sucesso
    Given o ambiente de alunos esta limpo
    And existe um aluno com nome "Diego" e email "diego@escola.com"
